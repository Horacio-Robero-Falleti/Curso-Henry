...
function crearGato(nombre, edad) {
  ...
  var registro = { nombre:nombre , edad:edad , meow:function() { return "Meow!"; }};
  return registro;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  multiplo = objetoMisterioso.numeroMisterioso * 5;
  return multiplo;
}
...
function sumarLikesDeUsuario(usuario) {
  ...
  var todo = usuario;
  var suma = 0;
  var contador = todo.posts.length;
  for (i =0; i < contador; i++) {
    suma = suma + todo.posts[i].likes; }
  return suma;
}
